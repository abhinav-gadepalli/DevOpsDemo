 ...
 * @author Team AXA
 * 
 * This Class  contains reusable  functions to read/ write  from/to data into external sheets
 * */
...
public class ExcelReader {
	...
	/*
	 * 
	 * This function reads all the sheet
	 * */
	...
	/*
	 * 
	 * This function returns the row count in a sheet
	 * */
	...
	/*
	 * 
	 * This function returns the data from a cell
	 * */
		...
		/*	System.out.println( row.getCell(3).getStringCellValue());*/
			for (int i = 0; i < row.getLastCellNum(); i++) {
				...
				if (row.getCell(i).getStringCellValue().trim().equals(colName.trim()))
					col_Num = i;
				/*System.out.println("COLUMN NO ::"+col_Num);*/
			}
			if (col_Num == -1)
				return "";
			...
			if (cell.getCellType() == Cell.CELL_TYPE_STRING){
				/*System.out.println("CHECKING THE VALUE"+cell.getStringCellValue());*/
	...
	/* returns the data from a cell*/
		public String getCellDatas(String sheetName, String colName, int rowNum) {
			try {
				if (rowNum <= 0)
					return "";
				int index = 1;
